...
const page = () => {
  return (
    <>
      <header className="w-screen h-screen  flex justify-evenly items-center flex-col relative bg-black bg-opacity-50 ">
        <img
        ...
        <button className="bg-yellow-600 text-xl hover:bg-yellow-500 transition-all duration-700 rounded-tl-3xl font-got font-bold rounded-ee-3xl text-white p-4">
          Register Now
        </button>
      </header>
      <main className="bg-yellow-900 flex py-40 justify-center items-center">
        <Tabs defaultValue="account" className="w-[90%] text-white">
          ...
          <TabsContent
            className="w-[80%] p-8 border-2 border-orange-600"
            value="account"
          >
            Ethereon has been an example in achieving huge feats with
            unparalleled figures ever since its inception in 1998. Ethereon has
            grown in stature in terms of its content, infrastructure, and
            ...
            has made our dream a technological extravaganza. With such vastness
            and diversity, the hospitality of the guests is of paramount
            importance. We, at Ethereon, constantly strive towards the
            satisfaction of everyone. We shall leave no stone unturned in
            fulfilling the needs of secure accommodation away from home. Along
            with accommodation facilities for our participants, we also set up a
            cafeteria serving a variety of cuisines satisfying the needs of
            every palate. We strive to make your stay comfortable and your
            experience, a memorable one. Hospitality management would be one of
            the prime focuses of Team Ethereon 2023-24. Hope to see you at
          ...
          >
            <div className="flex flex-col gap-4">
              <div className="flex gap-10 ">
                ...
                <p className="">
                  Accommodation charges are INR 2999 3499 (Early Bird Offer) per
                  candidate for 5 days. Maximum of 5 nights stay allowed (26th
                  Dec 6 AM - 30th Dec 10 AM). It does not include food facility.
                  Guest can purchase their meals from the food court, night
                  cafeteria or private hostel canteens or hostel messes at
                  subsidized rates.
                </p>
              </div>
              ...
              <div className="flex gap-10">
                ...
                <p className="">
                  ...
                  deadline, 75% of the total amount shall be refunded within 10
                  working days after the festival. There shall be no refunds for
                  cancellation after the deadline.Deadline of cancellation: 10th
                  December 2023.
                </p>
              </div>
            </div>
          ...
          <TabsContent
            className="w-[80%] p-8 flex flex-col gap-4 border-2 border-orange-600"
            value="instructions"
          >
            <div className="">
              ...
              to do so will result in the belongings being impounded.
            </div>

            <div className="">
              2. All guests will be provided with a mattress. Ethereon will not
            ...
            <div className="">
              ...
              in sound condition to the organizers during check-out.
            </div>
          ...
          >
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger>How to avail accommodation?</AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  ...
                  printout and the mandatory documents. Failing to bring any of
                  the documents may lead to the cancellation of your
                  accommodation.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  Confirmation is not confirmed till a confirmation mail is not
                  received in 24 hours. If not received confirmation in 24
                  hours, then mail your transaction ID, Techfest ID, name,
                  amount to nivesh@techfest.org with the subject as Transaction
                  ID :: team ID :: Confirmation mail not received.
                </AccordionContent>
              </AccordionItem>
